...
// Because of the static keyword, the constant is not visible outside of the file
...
- (void)saveRun
{
    ...
    for (CLLocation *location in self.locations) {
        ...
        locationObject.longitud = [NSNumber numberWithDouble:location.coordinate.longitude];
