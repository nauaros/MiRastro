...
+ (NSArray *)colorSegmentsForLocations:(NSArray *)locations
{
    ...
    for (int i = 1; i < locations.count; i++) {
        Location *firstLoc = (Location *)locations[i - 1];
        Location *secondLoc =  (Location *)locations[i];
        ...
        double time = [secondLocCL.timestamp timeIntervalSinceDate:firstLoc.timestamp];
    ...
    for (int i = 1; i < locations.count; i++) {
        Location *firstLoc = locations[i - 1];
        Location *secondLoc = locations[i];
        
        CLLocationCoordinate2D coords[2];
        coords[0].latitude = firstLoc.latitude.doubleValue;
        coords[0].longitude = firstLoc.longitud.doubleValue;
        
        coords[1].latitude = secondLoc.latitude.doubleValue;
        coords[1].longitude = secondLoc.longitud.doubleValue;
        
        NSNumber *speed = speeds[i - 1];
